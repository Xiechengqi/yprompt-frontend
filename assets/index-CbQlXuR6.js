const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LoginView-DiHjQx_7.js","assets/check-AFDIFzn_.js","assets/LoginView-CvtPeKJ9.css","assets/AuthCallback-XGxjKMdH.js","assets/AuthCallback-DAHntk-2.css","assets/GenerateModule-DRvYZ_6L.js","assets/apiService-Dz_ZRgzF.js","assets/ModelDialog.vue_vue_type_script_setup_true_lang-Ce9P3oop.js","assets/FinalTab.vue_vue_type_script_setup_true_lang-BrTpNWQM.js","assets/FinalTab-CDvh1RBw.css","assets/SavePromptDialog.vue_vue_type_script_setup_true_lang-sGOouhMw.js","assets/OptimizeModule-DUUNsQkv.js","assets/SettingsModal.vue_vue_type_script_setup_true_lang-BycjtCcK.js","assets/OptimizeModule-C8JMchR2.css","assets/PlaygroundModule-CwPkrzYM.js","assets/PlaygroundModule-BDv4wRAz.css","assets/LibraryModule-BpfYEMOk.js","assets/LibraryModule-CsIas7Q0.css"])))=>i.map(i=>d[i]);
var Lp=Object.defineProperty;var Fp=(e,t,i)=>t in e?Lp(e,t,{enumerable:!0,configurable:!0,writable:!0,value:i}):e[t]=i;var Nn=(e,t,i)=>Fp(e,typeof t!="symbol"?t+"":t,i);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function i(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(o){if(o.ep)return;o.ep=!0;const s=i(o);fetch(o.href,s)}})();const Dp="modulepreload",qp=function(e){return"/"+e},Qa={},_e=function(t,i,n){let o=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),a=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));o=Promise.allSettled(i.map(l=>{if(l=qp(l),l in Qa)return;Qa[l]=!0;const u=l.endsWith(".css"),c=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${c}`))return;const h=document.createElement("link");if(h.rel=u?"stylesheet":Dp,u||(h.as="script"),h.crossOrigin="",h.href=l,a&&h.setAttribute("nonce",a),document.head.appendChild(h),u)return new Promise((d,p)=>{h.addEventListener("load",d),h.addEventListener("error",()=>p(new Error(`Unable to preload CSS for ${l}`)))})}))}function s(r){const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=r,window.dispatchEvent(a),!a.defaultPrevented)throw r}return o.then(r=>{for(const a of r||[])a.status==="rejected"&&s(a.reason);return t().catch(s)})};/**
* @vue/shared v3.5.21
...
**/const oc=Object.create(null);function Sv(e,t){if(!ie(e))if(e.nodeType)e=e.innerHTML;else return He;const i=Hp(e,t),n=oc[i];if(n)return n;if(e[0]==="#"){const a=document.querySelector(e);e=a?a.innerHTML:""}const o=le({hoistStatic:!0,onError:void 0,onWarn:He},t);!o.isCustomElement&&typeof customElements<"u"&&(o.isCustomElement=a=>!!customElements.get(a));const{code:s}=kv(e,o),r=new Function("Vue",s)(Cg);return r._rc=!0,oc[i]=r}nh(Sv);/*!
  ...
  * @license MIT
  */const rn=typeof document<"u";function yp(e){return typeof e=="object"||"displayName"in e||"props"in e||"__vccOpts"in e}function Av(e){return e.__esModule||e[Symbol.toStringTag]==="Module"||e.default&&yp(e.default)}const me=Object.assign;function ur(e,t){const i={};for(const n in t){const o=t[n];i[n]=Rt(o)?o.map(e):e(o)}return i}const Qn=()=>{},Rt=Array.isArray,vp=/#/g,Iv=/&/g,Pv=/\//g,_v=/=/g,xv=/\?/g,bp=/\+/g,Cv=/%5B/g,Ev=/%5D/g,wp=/%5E/g,Rv=/%60/g,Tp=/%7B/g,Ov=/%7C/g,kp=/%7D/g,Mv=/%20/g;function Va(e){return encodeURI(""+e).replace(Ov,"|").replace(Cv,"[").replace(Ev,"]")}function Nv(e){return Va(e).replace(Tp,"{").replace(kp,"}").replace(wp,"^")}function Ur(e){return Va(e).replace(bp,"%2B").replace(Mv,"+").replace(vp,"%23").replace(Iv,"%26").replace(Rv,"`").replace(Tp,"{").replace(kp,"}").replace(wp,"^")}function Lv(e){return Ur(e).replace(_v,"%3D")}function Fv(e){return Va(e).replace(vp,"%23").replace(xv,"%3F")}function Dv(e){return e==null?"":Fv(e).replace(Pv,"%2F")}function go(e){try{return decodeURIComponent(""+e)}catch{}return""+e}const qv=/\/$/,Bv=e=>e.replace(qv,"");function hr(e,t,i="/"){let n,o={},s="",r="";const a=t.indexOf("#");let l=t.indexOf("?");return a<l&&a>=0&&(l=-1),l>-1&&(n=t.slice(0,l),s=t.slice(l+1,a>-1?a:t.length),o=e(s)),a>-1&&(n=n||t.slice(0,a),r=t.slice(a,t.length)),n=jv(n??t,i),{fullPath:n+(s&&"?")+s+r,path:n,query:o,hash:go(r)}}function zv(e,t){const i=t.query?e(t.query):"";return t.path+(i&&"?")+i+(t.hash||"")}function sc(e,t){return!t||!e.toLowerCase().startsWith(t.toLowerCase())?e:e.slice(t.length)||"/"}function Uv(e,t,i){const n=t.matched.length-1,o=i.matched.length-1;return n>-1&&n===o&&An(t.matched[n],i.matched[o])&&Sp(t.params,i.params)&&e(t.query)===e(i.query)&&t.hash===i.hash}function An(e,t){return(e.aliasOf||e)===(t.aliasOf||t)}function Sp(e,t){if(Object.keys(e).length!==Object.keys(t).length)return!1;for(const i in e)if(!Wv(e[i],t[i]))return!1;return!0}function Wv(e,t){return Rt(e)?rc(e,t):Rt(t)?rc(t,e):e===t}function rc(e,t){return Rt(t)?e.length===t.length&&e.every((i,n)=>i===t[n]):e.length===1&&e[0]===t}function jv(e,t){if(e.startsWith("/"))return e;if(!e)return t;const i=t.split("/"),n=e.split("/"),o=n[n.length-1];(o===".."||o===".")&&n.push("");let s=i.length-1,r,a;for(r=0;r<n.length;r++)if(a=n[r],a!==".")if(a==="..")s>1&&s--;else break;return i.slice(0,s).join("/")+"/"+n.slice(r).join("/")}const si={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0};var yo;(function(e){e.pop="pop",e.push="push"})(yo||(yo={}));var Zn;(function(e){e.back="back",e.forward="forward",e.unknown=""})(Zn||(Zn={}));function Vv(e){if(!e)if(rn){const t=document.querySelector("base");e=t&&t.getAttribute("href")||"/",e=e.replace(/^\w+:\/\/[^\/]+/,"")}else e="/";return e[0]!=="/"&&e[0]!=="#"&&(e="/"+e),Bv(e)}const Hv=/^[^#]+#/;function Gv(e,t){return e.replace(Hv,"#")+t}function $v(e,t){const i=document.documentElement.getBoundingClientRect(),n=e.getBoundingClientRect();return{behavior:t.behavior,left:n.left-i.left-(t.left||0),top:n.top-i.top-(t.top||0)}}const Gs=()=>({left:window.scrollX,top:window.scrollY});function Yv(e){let t;if("el"in e){const i=e.el,n=typeof i=="string"&&i.startsWith("#"),o=typeof i=="string"?n?document.getElementById(i.slice(1)):document.querySelector(i):i;if(!o)return;t=$v(o,e)}else t=e;"scrollBehavior"in document.documentElement.style?window.scrollTo(t):window.scrollTo(t.left!=null?t.left:window.scrollX,t.top!=null?t.top:window.scrollY)}function ac(e,t){return(history.state?history.state.position-t:-1)+e}const Wr=new Map;function Kv(e,t){Wr.set(e,t)}function Jv(e){const t=Wr.get(e);return Wr.delete(e),t}let Qv=()=>location.protocol+"//"+location.host;function Ap(e,t){const{pathname:i,search:n,hash:o}=t,s=e.indexOf("#");if(s>-1){let a=o.includes(e.slice(s))?e.slice(s).length:1,l=o.slice(a);return l[0]!=="/"&&(l="/"+l),sc(l,"")}return sc(i,e)+n+o}function Zv(e,t,i,n){let o=[],s=[],r=null;const a=({state:d})=>{const p=Ap(e,location),y=i.value,v=t.value;let C=0;if(d){if(i.value=p,t.value=d,r&&r===y){r=null;return}C=v?d.position-v.position:0}else n(p);o.forEach(_=>{_(i.value,y,{delta:C,type:yo.pop,direction:C?C>0?Zn.forward:Zn.back:Zn.unknown})})};function l(){r=i.value}function u(d){o.push(d);const p=()=>{const y=o.indexOf(d);y>-1&&o.splice(y,1)};return s.push(p),p}function c(){const{history:d}=window;d.state&&d.replaceState(me({},d.state,{scroll:Gs()}),"")}function h(){for(const d of s)d();s=[],window.removeEventListener("popstate",a),window.removeEventListener("beforeunload",c)}return window.addEventListener("popstate",a),window.addEventListener("beforeunload",c,{passive:!0}),{pauseListeners:l,listen:u,destroy:h}}function lc(e,t,i,n=!1,o=!1){return{back:e,current:t,forward:i,replaced:n,position:window.history.length,scroll:o?Gs():null}}function Xv(e){const{history:t,location:i}=window,n={value:Ap(e,i)},o={value:t.state};o.value||s(n.value,{back:null,current:n.value,forward:null,position:t.length-1,replaced:!0,scroll:null},!0);function s(l,u,c){const h=e.indexOf("#"),d=h>-1?(i.host&&document.querySelector("base")?e:e.slice(h))+l:Qv()+e+l;try{t[c?"replaceState":"pushState"](u,"",d),o.value=u}catch(p){console.error(p),i[c?"replace":"assign"](d)}}function r(l,u){const c=me({},t.state,lc(o.value.back,l,o.value.forward,!0),u,{position:o.value.position});s(l,c,!0),n.value=l}function a(l,u){const c=me({},o.value,t.state,{forward:l,scroll:Gs()});s(c.current,c,!0);const h=me({},lc(n.value,l,null),{position:c.position+1},u);s(l,h,!1),n.value=l}return{location:n,state:o,push:a,replace:r}}function eb(e){e=Vv(e);const t=Xv(e),i=Zv(e,t.state,t.location,t.replace);function n(s,r=!0){r||i.pauseListeners(),history.go(s)}const o=me({location:"",base:e,go:n,createHref:Gv.bind(null,e)},t,i);return Object.defineProperty(o,"location",{enumerable:!0,get:()=>t.location.value}),Object.defineProperty(o,"state",{enumerable:!0,get:()=>t.state.value}),o}function tb(e){return typeof e=="string"||e&&typeof e=="object"}function Ip(e){return typeof e=="string"||typeof e=="symbol"}const Pp=Symbol("");var cc;(function(e){e[e.aborted=4]="aborted",e[e.cancelled=8]="cancelled",e[e.duplicated=16]="duplicated"})(cc||(cc={}));function In(e,t){return me(new Error,{type:e,[Pp]:!0},t)}function zt(e,t){return e instanceof Error&&Pp in e&&(t==null||!!(e.type&t))}const uc="[^/]+?",ib={sensitive:!1,strict:!1,start:!0,end:!0},nb=/[.+*?^${}()[\]/\\]/g;function ob(e,t){const i=me({},ib,t),n=[];let o=i.start?"^":"";const s=[];for(const u of e){const c=u.length?[]:[90];i.strict&&!u.length&&(o+="/");for(let h=0;h<u.length;h++){const d=u[h];let p=40+(i.sensitive?.25:0);if(d.type===0)h||(o+="/"),o+=d.value.replace(nb,"\\$&"),p+=40;else if(d.type===1){const{value:y,repeatable:v,optional:C,regexp:_}=d;s.push({name:y,repeatable:v,optional:C});const k=_||uc;if(k!==uc){p+=10;try{new RegExp(`(${k})`)}catch(b){throw new Error(`Invalid custom RegExp for param "${y}" (${k}): `+b.message)}}let m=v?`((?:${k})(?:/(?:${k}))*)`:`(${k})`;h||(m=C&&u.length<2?`(?:/${m})`:"/"+m),C&&(m+="?"),o+=m,p+=20,C&&(p+=-8),v&&(p+=-20),k===".*"&&(p+=-50)}c.push(p)}n.push(c)}if(i.strict&&i.end){const u=n.length-1;n[u][n[u].length-1]+=.7000000000000001}i.strict||(o+="/?"),i.end?o+="$":i.strict&&!o.endsWith("/")&&(o+="(?:/|$)");const r=new RegExp(o,i.sensitive?"":"i");function a(u){const c=u.match(r),h={};if(!c)return null;for(let d=1;d<c.length;d++){const p=c[d]||"",y=s[d-1];h[y.name]=p&&y.repeatable?p.split("/"):p}return h}function l(u){let c="",h=!1;for(const d of e){(!h||!c.endsWith("/"))&&(c+="/"),h=!1;for(const p of d)if(p.type===0)c+=p.value;else if(p.type===1){const{value:y,repeatable:v,optional:C}=p,_=y in u?u[y]:"";if(Rt(_)&&!v)throw new Error(`Provided param "${y}" is an array but it is not repeatable (* or + modifiers)`);const k=Rt(_)?_.join("/"):_;if(!k)if(C)d.length<2&&(c.endsWith("/")?c=c.slice(0,-1):h=!0);else throw new Error(`Missing required param "${y}"`);c+=k}}return c||"/"}return{re:r,score:n,keys:s,parse:a,stringify:l}}function sb(e,t){let i=0;for(;i<e.length&&i<t.length;){const n=t[i]-e[i];if(n)return n;i++}return e.length<t.length?e.length===1&&e[0]===80?-1:1:e.length>t.length?t.length===1&&t[0]===80?1:-1:0}function _p(e,t){let i=0;const n=e.score,o=t.score;for(;i<n.length&&i<o.length;){const s=sb(n[i],o[i]);if(s)return s;i++}if(Math.abs(o.length-n.length)===1){if(hc(n))return 1;if(hc(o))return-1}return o.length-n.length}function hc(e){const t=e[e.length-1];return e.length>0&&t[t.length-1]<0}const rb={type:0,value:""},ab=/[a-zA-Z0-9_]/;function lb(e){if(!e)return[[]];if(e==="/")return[[rb]];if(!e.startsWith("/"))throw new Error(`Invalid path "${e}"`);function t(p){throw new Error(`ERR (${i})/"${u}": ${p}`)}let i=0,n=i;const o=[];let s;function r(){s&&o.push(s),s=[]}let a=0,l,u="",c="";function h(){u&&(i===0?s.push({type:0,value:u}):i===1||i===2||i===3?(s.length>1&&(l==="*"||l==="+")&&t(`A repeatable param (${u}) must be alone in its segment. eg: '/:ids+.`),s.push({type:1,value:u,regexp:c,repeatable:l==="*"||l==="+",optional:l==="*"||l==="?"})):t("Invalid state to consume buffer"),u="")}function d(){u+=l}for(;a<e.length;){if(l=e[a++],l==="\\"&&i!==2){n=i,i=4;continue}switch(i){case 0:l==="/"?(u&&h(),r()):l===":"?(h(),i=1):d();break;case 4:d(),i=n;break;case 1:l==="("?i=2:ab.test(l)?d():(h(),i=0,l!=="*"&&l!=="?"&&l!=="+"&&a--);break;case 2:l===")"?c[c.length-1]=="\\"?c=c.slice(0,-1)+l:i=3:c+=l;break;case 3:h(),i=0,l!=="*"&&l!=="?"&&l!=="+"&&a--,c="";break;default:t("Unknown state");break}}return i===2&&t(`Unfinished custom RegExp for param "${u}"`),h(),r(),o}function cb(e,t,i){const n=ob(lb(e.path),i),o=me(n,{record:e,parent:t,children:[],alias:[]});return t&&!o.record.aliasOf==!t.record.aliasOf&&t.children.push(o),o}function ub(e,t){const i=[],n=new Map;t=mc({strict:!1,end:!0,sensitive:!1},t);function o(h){return n.get(h)}function s(h,d,p){const y=!p,v=dc(h);v.aliasOf=p&&p.record;const C=mc(t,h),_=[v];if("alias"in h){const b=typeof h.alias=="string"?[h.alias]:h.alias;for(const S of b)_.push(dc(me({},v,{components:p?p.record.components:v.components,path:S,aliasOf:p?p.record:v})))}let k,m;for(const b of _){const{path:S}=b;if(d&&S[0]!=="/"){const F=d.record.path,q=F[F.length-1]==="/"?"":"/";b.path=d.record.path+(S&&q+S)}if(k=cb(b,d,C),p?p.alias.push(k):(m=m||k,m!==k&&m.alias.push(k),y&&h.name&&!fc(k)&&r(h.name)),xp(k)&&l(k),v.children){const F=v.children;for(let q=0;q<F.length;q++)s(F[q],k,p&&p.children[q])}p=p||k}return m?()=>{r(m)}:Qn}function r(h){if(Ip(h)){const d=n.get(h);d&&(n.delete(h),i.splice(i.indexOf(d),1),d.children.forEach(r),d.alias.forEach(r))}else{const d=i.indexOf(h);d>-1&&(i.splice(d,1),h.record.name&&n.delete(h.record.name),h.children.forEach(r),h.alias.forEach(r))}}function a(){return i}function l(h){const d=db(h,i);i.splice(d,0,h),h.record.name&&!fc(h)&&n.set(h.record.name,h)}function u(h,d){let p,y={},v,C;if("name"in h&&h.name){if(p=n.get(h.name),!p)throw In(1,{location:h});C=p.record.name,y=me(pc(d.params,p.keys.filter(m=>!m.optional).concat(p.parent?p.parent.keys.filter(m=>m.optional):[]).map(m=>m.name)),h.params&&pc(h.params,p.keys.map(m=>m.name))),v=p.stringify(y)}else if(h.path!=null)v=h.path,p=i.find(m=>m.re.test(v)),p&&(y=p.parse(v),C=p.record.name);else{if(p=d.name?n.get(d.name):i.find(m=>m.re.test(d.path)),!p)throw In(1,{location:h,currentLocation:d});C=p.record.name,y=me({},d.params,h.params),v=p.stringify(y)}const _=[];let k=p;for(;k;)_.unshift(k.record),k=k.parent;return{name:C,path:v,params:y,matched:_,meta:pb(_)}}e.forEach(h=>s(h));function c(){i.length=0,n.clear()}return{addRoute:s,resolve:u,removeRoute:r,clearRoutes:c,getRoutes:a,getRecordMatcher:o}}function pc(e,t){const i={};for(const n of t)n in e&&(i[n]=e[n]);return i}function dc(e){const t={path:e.path,redirect:e.redirect,name:e.name,meta:e.meta||{},aliasOf:e.aliasOf,beforeEnter:e.beforeEnter,props:hb(e),children:e.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in e?e.components||null:e.component&&{default:e.component}};return Object.defineProperty(t,"mods",{value:{}}),t}function hb(e){const t={},i=e.props||!1;if("component"in e)t.default=i;else for(const n in e.components)t[n]=typeof i=="object"?i[n]:i;return t}function fc(e){for(;e;){if(e.record.aliasOf)return!0;e=e.parent}return!1}function pb(e){return e.reduce((t,i)=>me(t,i.meta),{})}function mc(e,t){const i={};for(const n in e)i[n]=n in t?t[n]:e[n];return i}function db(e,t){let i=0,n=t.length;for(;i!==n;){const s=i+n>>1;_p(e,t[s])<0?n=s:i=s+1}const o=fb(e);return o&&(n=t.lastIndexOf(o,n-1)),n}function fb(e){let t=e;for(;t=t.parent;)if(xp(t)&&_p(e,t)===0)return t}function xp({record:e}){return!!(e.name||e.components&&Object.keys(e.components).length||e.redirect)}function mb(e){const t={};if(e===""||e==="?")return t;const n=(e[0]==="?"?e.slice(1):e).split("&");for(let o=0;o<n.length;++o){const s=n[o].replace(bp," "),r=s.indexOf("="),a=go(r<0?s:s.slice(0,r)),l=r<0?null:go(s.slice(r+1));if(a in t){let u=t[a];Rt(u)||(u=t[a]=[u]),u.push(l)}else t[a]=l}return t}function gc(e){let t="";for(let i in e){const n=e[i];if(i=Lv(i),n==null){n!==void 0&&(t+=(t.length?"&":"")+i);continue}(Rt(n)?n.map(s=>s&&Ur(s)):[n&&Ur(n)]).forEach(s=>{s!==void 0&&(t+=(t.length?"&":"")+i,s!=null&&(t+="="+s))})}return t}function gb(e){const t={};for(const i in e){const n=e[i];n!==void 0&&(t[i]=Rt(n)?n.map(o=>o==null?null:""+o):n==null?n:""+n)}return t}const yb=Symbol(""),yc=Symbol(""),$s=Symbol(""),Ha=Symbol(""),jr=Symbol("");function qn(){let e=[];function t(n){return e.push(n),()=>{const o=e.indexOf(n);o>-1&&e.splice(o,1)}}function i(){e=[]}return{add:t,list:()=>e.slice(),reset:i}}function pi(e,t,i,n,o,s=r=>r()){const r=n&&(n.enterCallbacks[o]=n.enterCallbacks[o]||[]);return()=>new Promise((a,l)=>{const u=d=>{d===!1?l(In(4,{from:i,to:t})):d instanceof Error?l(d):tb(d)?l(In(2,{from:t,to:d})):(r&&n.enterCallbacks[o]===r&&typeof d=="function"&&r.push(d),a())},c=s(()=>e.call(n&&n.instances[o],t,i,u));let h=Promise.resolve(c);e.length<3&&(h=h.then(u)),h.catch(d=>l(d))})}function pr(e,t,i,n,o=s=>s()){const s=[];for(const r of e)for(const a in r.components){let l=r.components[a];if(!(t!=="beforeRouteEnter"&&!r.instances[a]))if(yp(l)){const c=(l.__vccOpts||l)[t];c&&s.push(pi(c,i,n,r,a,o))}else{let u=l();s.push(()=>u.then(c=>{if(!c)throw new Error(`Couldn't resolve component "${a}" at "${r.path}"`);const h=Av(c)?c.default:c;r.mods[a]=c,r.components[a]=h;const p=(h.__vccOpts||h)[t];return p&&pi(p,i,n,r,a,o)()}))}}return s}function vc(e){const t=vt($s),i=vt(Ha),n=Be(()=>{const l=we(e.to);return t.resolve(l)}),o=Be(()=>{const{matched:l}=n.value,{length:u}=l,c=l[u-1],h=i.matched;if(!c||!h.length)return-1;const d=h.findIndex(An.bind(null,c));if(d>-1)return d;const p=bc(l[u-2]);return u>1&&bc(c)===p&&h[h.length-1].path!==p?h.findIndex(An.bind(null,l[u-2])):d}),s=Be(()=>o.value>-1&&kb(i.params,n.value.params)),r=Be(()=>o.value>-1&&o.value===i.matched.length-1&&Sp(i.params,n.value.params));function a(l={}){if(Tb(l)){const u=t[we(e.replace)?"replace":"push"](we(e.to)).catch(Qn);return e.viewTransition&&typeof document<"u"&&"startViewTransition"in document&&document.startViewTransition(()=>u),u}return Promise.resolve()}return{route:n,href:Be(()=>n.value.href),isActive:s,isExactActive:r,navigate:a}}function vb(e){return e.length===1?e[0]:e}const bb=Pt({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"},viewTransition:Boolean},useLink:vc,setup(e,{slots:t}){const i=xn(vc(e)),{options:n}=vt($s),o=Be(()=>({[wc(e.activeClass,n.linkActiveClass,"router-link-active")]:i.isActive,[wc(e.exactActiveClass,n.linkExactActiveClass,"router-link-exact-active")]:i.isExactActive}));return()=>{const s=t.default&&vb(t.default(i));return e.custom?s:Fe("a",{"aria-current":i.isExactActive?e.ariaCurrentValue:null,href:i.href,onClick:i.navigate,class:o.value},s)}}}),wb=bb;function Tb(e){if(!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)&&!e.defaultPrevented&&!(e.button!==void 0&&e.button!==0)){if(e.currentTarget&&e.currentTarget.getAttribute){const t=e.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(t))return}return e.preventDefault&&e.preventDefault(),!0}}function kb(e,t){for(const i in t){const n=t[i],o=e[i];if(typeof n=="string"){if(n!==o)return!1}else if(!Rt(o)||o.length!==n.length||n.some((s,r)=>s!==o[r]))return!1}return!0}function bc(e){return e?e.aliasOf?e.aliasOf.path:e.path:""}const wc=(e,t,i)=>e??t??i,Sb=Pt({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(e,{attrs:t,slots:i}){const n=vt(jr),o=Be(()=>e.route||n.value),s=vt(yc,0),r=Be(()=>{let u=we(s);const{matched:c}=o.value;let h;for(;(h=c[u])&&!h.components;)u++;return u}),a=Be(()=>o.value.matched[r.value]);$n(yc,Be(()=>r.value+1)),$n(yb,a),$n(jr,o);const l=he();return $t(()=>[l.value,a.value,e.name],([u,c,h],[d,p,y])=>{c&&(c.instances[h]=u,p&&p!==c&&u&&u===d&&(c.leaveGuards.size||(c.leaveGuards=p.leaveGuards),c.updateGuards.size||(c.updateGuards=p.updateGuards))),u&&c&&(!p||!An(c,p)||!d)&&(c.enterCallbacks[h]||[]).forEach(v=>v(u))},{flush:"post"}),()=>{const u=o.value,c=e.name,h=a.value,d=h&&h.components[c];if(!d)return Tc(i.default,{Component:d,route:u});const p=h.props[c],y=p?p===!0?u.params:typeof p=="function"?p(u):p:null,C=Fe(d,me({},y,t,{onVnodeUnmounted:_=>{_.component.isUnmounted&&(h.instances[c]=null)},ref:l}));return Tc(i.default,{Component:C,route:u})||C}}});function Tc(e,t){if(!e)return null;const i=e(t);return i.length===1?i[0]:i}const Ab=Sb;function Ib(e){const t=ub(e.routes,e),i=e.parseQuery||mb,n=e.stringifyQuery||gc,o=e.history,s=qn(),r=qn(),a=qn(),l=sa(si);let u=si;rn&&e.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const c=ur.bind(null,N=>""+N),h=ur.bind(null,Dv),d=ur.bind(null,go);function p(N,G){let V,J;return Ip(N)?(V=t.getRecordMatcher(N),J=G):J=N,t.addRoute(J,V)}function y(N){const G=t.getRecordMatcher(N);G&&t.removeRoute(G)}function v(){return t.getRoutes().map(N=>N.record)}function C(N){return!!t.getRecordMatcher(N)}function _(N,G){if(G=me({},G||l.value),typeof N=="string"){const g=hr(i,N,G.path),I=t.resolve({path:g.path},G),D=o.createHref(g.fullPath);return me(g,I,{params:d(I.params),hash:go(g.hash),redirectedFrom:void 0,href:D})}let V;if(N.path!=null)V=me({},N,{path:hr(i,N.path,G.path).path});else{const g=me({},N.params);for(const I in g)g[I]==null&&delete g[I];V=me({},N,{params:h(g)}),G.params=h(G.params)}const J=t.resolve(V,G),ue=N.hash||"";J.params=c(d(J.params));const Te=zv(n,me({},N,{hash:Nv(ue),path:J.path})),f=o.createHref(Te);return me({fullPath:Te,hash:ue,query:n===gc?gb(N.query):N.query||{}},J,{redirectedFrom:void 0,href:f})}function k(N){return typeof N=="string"?hr(i,N,l.value.path):me({},N)}function m(N,G){if(u!==N)return In(8,{from:G,to:N})}function b(N){return q(N)}function S(N){return b(me(k(N),{replace:!0}))}function F(N){const G=N.matched[N.matched.length-1];if(G&&G.redirect){const{redirect:V}=G;let J=typeof V=="function"?V(N):V;return typeof J=="string"&&(J=J.includes("?")||J.includes("#")?J=k(J):{path:J},J.params={}),me({query:N.query,hash:N.hash,params:J.path!=null?{}:N.params},J)}}function q(N,G){const V=u=_(N),J=l.value,ue=N.state,Te=N.force,f=N.replace===!0,g=F(V);if(g)return q(me(k(g),{state:typeof g=="object"?me({},ue,g.state):ue,force:Te,replace:f}),G||V);const I=V;I.redirectedFrom=G;let D;return!Te&&Uv(n,J,V)&&(D=In(16,{to:I,from:J}),$e(J,J,!0,!1)),(D?Promise.resolve(D):P(I,J)).catch(O=>zt(O)?zt(O,2)?O:Ge(O):$(O,I,J)).then(O=>{if(O){if(zt(O,2))return q(me({replace:f},k(O.to),{state:typeof O.to=="object"?me({},ue,O.to.state):ue,force:Te}),G||I)}else O=A(I,J,!0,f,ue);return B(I,J,O),O})}function E(N,G){const V=m(N,G);return V?Promise.reject(V):Promise.resolve()}function w(N){const G=ii.values().next().value;return G&&typeof G.runWithContext=="function"?G.runWithContext(N):N()}function P(N,G){let V;const[J,ue,Te]=Pb(N,G);V=pr(J.reverse(),"beforeRouteLeave",N,G);for(const g of J)g.leaveGuards.forEach(I=>{V.push(pi(I,N,G))});const f=E.bind(null,N,G);return V.push(f),ot(V).then(()=>{V=[];for(const g of s.list())V.push(pi(g,N,G));return V.push(f),ot(V)}).then(()=>{V=pr(ue,"beforeRouteUpdate",N,G);for(const g of ue)g.updateGuards.forEach(I=>{V.push(pi(I,N,G))});return V.push(f),ot(V)}).then(()=>{V=[];for(const g of Te)if(g.beforeEnter)if(Rt(g.beforeEnter))for(const I of g.beforeEnter)V.push(pi(I,N,G));else V.push(pi(g.beforeEnter,N,G));return V.push(f),ot(V)}).then(()=>(N.matched.forEach(g=>g.enterCallbacks={}),V=pr(Te,"beforeRouteEnter",N,G,w),V.push(f),ot(V))).then(()=>{V=[];for(const g of r.list())V.push(pi(g,N,G));return V.push(f),ot(V)}).catch(g=>zt(g,8)?g:Promise.reject(g))}function B(N,G,V){a.list().forEach(J=>w(()=>J(N,G,V)))}function A(N,G,V,J,ue){const Te=m(N,G);if(Te)return Te;const f=G===si,g=rn?history.state:{};V&&(J||f?o.replace(N.fullPath,me({scroll:f&&g&&g.scroll},ue)):o.push(N.fullPath,ue)),l.value=N,$e(N,G,V,f),Ge()}let z;function K(){z||(z=o.listen((N,G,V)=>{if(!Bi.listening)return;const J=_(N),ue=F(J);if(ue){q(me(ue,{replace:!0,force:!0}),J).catch(Qn);return}u=J;const Te=l.value;rn&&Kv(ac(Te.fullPath,V.delta),Gs()),P(J,Te).catch(f=>zt(f,12)?f:zt(f,2)?(q(me(k(f.to),{force:!0}),J).then(g=>{zt(g,20)&&!V.delta&&V.type===yo.pop&&o.go(-1,!1)}).catch(Qn),Promise.reject()):(V.delta&&o.go(-V.delta,!1),$(f,J,Te))).then(f=>{f=f||A(J,Te,!1),f&&(V.delta&&!zt(f,8)?o.go(-V.delta,!1):V.type===yo.pop&&zt(f,20)&&o.go(-1,!1)),B(J,Te,f)}).catch(Qn)}))}let Z=qn(),U=qn(),Y;function $(N,G,V){Ge(N);const J=U.list();return J.length?J.forEach(ue=>ue(N,G,V)):console.error(N),Promise.reject(N)}function be(){return Y&&l.value!==si?Promise.resolve():new Promise((N,G)=>{Z.add([N,G])})}function Ge(N){return Y||(Y=!N,K(),Z.list().forEach(([G,V])=>N?V(N):G()),Z.reset()),N}function $e(N,G,V,J){const{scrollBehavior:ue}=e;if(!rn||!ue)return Promise.resolve();const Te=!V&&Jv(ac(N.fullPath,0))||(J||!V)&&history.state&&history.state.scroll||null;return En().then(()=>ue(N,G,Te)).then(f=>f&&Yv(f)).catch(f=>$(f,N,G))}const Ye=N=>o.go(N);let ti;const ii=new Set,Bi={currentRoute:l,listening:!0,addRoute:p,removeRoute:y,clearRoutes:t.clearRoutes,hasRoute:C,getRoutes:v,resolve:_,options:e,push:b,replace:S,go:Ye,back:()=>Ye(-1),forward:()=>Ye(1),beforeEach:s.add,beforeResolve:r.add,afterEach:a.add,onError:U.add,isReady:be,install(N){const G=this;N.component("RouterLink",wb),N.component("RouterView",Ab),N.config.globalProperties.$router=G,Object.defineProperty(N.config.globalProperties,"$route",{enumerable:!0,get:()=>we(l)}),rn&&!ti&&l.value===si&&(ti=!0,b(o.location).catch(ue=>{}));const V={};for(const ue in si)Object.defineProperty(V,ue,{get:()=>l.value[ue],enumerable:!0});N.provide($s,G),N.provide(Ha,na(V)),N.provide(jr,l);const J=N.unmount;ii.add(N),N.unmount=function(){ii.delete(N),ii.size<1&&(u=si,z&&z(),z=null,l.value=si,ti=!1,Y=!1),J()}}};function ot(N){return N.reduce((G,V)=>G.then(()=>w(V)),Promise.resolve())}return Bi}function Pb(e,t){const i=[],n=[],o=[],s=Math.max(t.matched.length,e.matched.length);for(let r=0;r<s;r++){const a=t.matched[r];a&&(e.matched.find(u=>An(u,a))?n.push(a):i.push(a));const l=e.matched[r];l&&(t.matched.find(u=>An(u,l))||o.push(l))}return[i,n,o]}function _b(){return vt($s)}function xw(e){return vt(Ha)}/*!
 * pinia v2.3.1
 * (c) 2025 Eduardo San Martin Morote
 * @license MIT
 */let Cp;const Ys=e=>Cp=e,Ep=Symbol();function Vr(e){return e&&typeof e=="object"&&Object.prototype.toString.call(e)==="[object Object]"&&typeof e.toJSON!="function"}var Xn;(function(e){e.direct="direct",e.patchObject="patch object",e.patchFunction="patch function"})(Xn||(Xn={}));function xb(){const e=Zr(!0),t=e.run(()=>he({}));let i=[],n=[];const o=Os({install(s){Ys(o),o._a=s,s.provide(Ep,o),s.config.globalProperties.$pinia=o,n.forEach(r=>i.push(r)),n=[]},use(s){return this._a?i.push(s):n.push(s),this},_p:i,_a:null,_e:e,_s:new Map,state:t});return o}const Rp=()=>{};function kc(e,t,i,n=Rp){e.push(t);const o=()=>{const s=e.indexOf(t);s>-1&&(e.splice(s,1),n())};return!i&&Xr()&&Lc(o),o}function ji(e,...t){e.slice().forEach(i=>{i(...t)})}const Cb=e=>e(),Sc=Symbol(),dr=Symbol();function Hr(e,t){e instanceof Map&&t instanceof Map?t.forEach((i,n)=>e.set(n,i)):e instanceof Set&&t instanceof Set&&t.forEach(e.add,e);for(const i in t){if(!t.hasOwnProperty(i))continue;const n=t[i],o=e[i];Vr(o)&&Vr(n)&&e.hasOwnProperty(i)&&!Pe(n)&&!Ft(n)?e[i]=Hr(o,n):e[i]=n}return e}const Eb=Symbol();function Rb(e){return!Vr(e)||!e.hasOwnProperty(Eb)}const{assign:ai}=Object;function Ob(e){return!!(Pe(e)&&e.effect)}function Mb(e,t,i,n){const{state:o,actions:s,getters:r}=t,a=i.state.value[e];let l;function u(){a||(i.state.value[e]=o?o():{});const c=Xc(i.state.value[e]);return ai(c,s,Object.keys(r||{}).reduce((h,d)=>(h[d]=Os(Be(()=>{Ys(i);const p=i._s.get(e);return r[d].call(p,p)})),h),{}))}return l=Op(e,u,t,i,n,!0),l}function Op(e,t,i={},n,o,s){let r;const a=ai({actions:{}},i),l={deep:!0};let u,c,h=[],d=[],p;const y=n.state.value[e];!s&&!y&&(n.state.value[e]={}),he({});let v;function C(E){let w;u=c=!1,typeof E=="function"?(E(n.state.value[e]),w={type:Xn.patchFunction,storeId:e,events:p}):(Hr(n.state.value[e],E),w={type:Xn.patchObject,payload:E,storeId:e,events:p});const P=v=Symbol();En().then(()=>{v===P&&(u=!0)}),c=!0,ji(h,w,n.state.value[e])}const _=s?function(){const{state:w}=i,P=w?w():{};this.$patch(B=>{ai(B,P)})}:Rp;function k(){r.stop(),h=[],d=[],n._s.delete(e)}const m=(E,w="")=>{if(Sc in E)return E[dr]=w,E;const P=function(){Ys(n);const B=Array.from(arguments),A=[],z=[];function K(Y){A.push(Y)}function Z(Y){z.push(Y)}ji(d,{args:B,name:P[dr],store:S,after:K,onError:Z});let U;try{U=E.apply(this&&this.$id===e?this:S,B)}catch(Y){throw ji(z,Y),Y}return U instanceof Promise?U.then(Y=>(ji(A,Y),Y)).catch(Y=>(ji(z,Y),Promise.reject(Y))):(ji(A,U),U)};return P[Sc]=!0,P[dr]=w,P},b={_p:n,$id:e,$onAction:kc.bind(null,d),$patch:C,$reset:_,$subscribe(E,w={}){const P=kc(h,E,w.detached,()=>B()),B=r.run(()=>$t(()=>n.state.value[e],A=>{(w.flush==="sync"?c:u)&&E({storeId:e,type:Xn.direct,events:p},A)},ai({},l,w)));return P},$dispose:k},S=xn(b);n._s.set(e,S);const q=(n._a&&n._a.runWithContext||Cb)(()=>n._e.run(()=>(r=Zr()).run(()=>t({action:m}))));for(const E in q){const w=q[E];if(Pe(w)&&!Ob(w)||Ft(w))s||(y&&Rb(w)&&(Pe(w)?w.value=y[E]:Hr(w,y[E])),n.state.value[e][E]=w);else if(typeof w=="function"){const P=m(w,E);q[E]=P,a.actions[E]=w}}return ai(S,q),ai(ce(S),q),Object.defineProperty(S,"$state",{get:()=>n.state.value[e],set:E=>{C(w=>{ai(w,E)})}}),n._p.forEach(E=>{ai(S,r.run(()=>E({store:S,app:n._a,pinia:n,options:a})))}),y&&s&&i.hydrate&&i.hydrate(S.$state,y),u=!0,c=!0,S}/*! #__NO_SIDE_EFFECTS__ */function Ks(e,t,i){let n,o;const s=typeof t=="function";typeof e=="string"?(n=e,o=s?i:t):(o=e,n=e.id);function r(a,l){const u=_u();return a=a||(u?vt(Ep,null):null),a&&Ys(a),a=Cp,a._s.has(n)||(s?Op(n,t,o,a):Mb(n,o,a)),a._s.get(n)}return r.$id=n,r}const Ga=Ks("navigation",()=>{const e=he("generate"),t=he(!1),i=he(!1),n=[{id:"generate",name:"生成",icon:"🏠",path:"/generate",color:"#3B82F6"},{id:"optimize",name:"优化",icon:"⚡",path:"/optimize",color:"#F59E0B"},{id:"playground",name:"操练场",icon:"🎯",path:"/playground",color:"#10B981"},{id:"library",name:"我的",icon:"📚",path:"/library",color:"#8B5CF6"}],o=Be(()=>n.find(c=>c.id===e.value)||n[0]),s=Be(()=>t.value?"60px":"140px");return{currentModule:e,sidebarCollapsed:t,isMobile:i,modules:n,currentModuleConfig:o,sidebarWidth:s,setCurrentModule:c=>{e.value=c},toggleSidebar:()=>{t.value=!t.value},setMobile:c=>{i.value=c,c&&(t.value=!0)},getModuleByPath:c=>n.find(h=>h.path===c)}}),Mp=Ks("auth",()=>{const e=he(localStorage.getItem("yprompt_token")),t=he(null),i=he(!1),n=Be(()=>!!e.value&&!!t.value),o=p=>{e.value=p,p?localStorage.setItem("yprompt_token",p):localStorage.removeItem("yprompt_token")},s=p=>{t.value=p,p?localStorage.setItem("yprompt_user",JSON.stringify(p)):localStorage.removeItem("yprompt_user")},r=()=>{const p=localStorage.getItem("yprompt_user");if(p)try{t.value=JSON.parse(p)}catch{localStorage.removeItem("yprompt_user")}},a=async(p,y)=>{i.value=!0;try{const C=await(await fetch("/api/auth/local/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({username:p,password:y})})).json();if(C.code===200&&C.data){o(C.data.token),s(C.data.user);try{const{promptConfigManager:_}=await _e(async()=>{const{promptConfigManager:k}=await Promise.resolve().then(()=>Db);return{promptConfigManager:k}},void 0);await _.forceReloadFromCloud()}catch(_){console.error("登录后加载云端配置失败:",_)}return!0}else return!1}catch{return!1}finally{i.value=!1}},l=async()=>{try{const y=await(await fetch("/api/auth/config")).json();return y.code===200&&y.data?y.data:null}catch{return null}},u=async()=>{if(!e.value)return!1;try{const y=await(await fetch("/api/auth/refresh",{method:"POST",headers:{Authorization:`Bearer ${e.value}`,"Content-Type":"application/json"}})).json();return y.code===200&&y.data?(o(y.data.token),!0):!1}catch{return!1}},c=async()=>{if(!e.value)return!1;try{const y=await(await fetch("/api/auth/userinfo",{method:"GET",headers:{Authorization:`Bearer ${e.value}`}})).json();return y.code===200&&y.data?(s(y.data),!0):!1}catch{return!1}};return{token:e,user:t,isLoading:i,isLoggedIn:n,setToken:o,setUser:s,loginWithPassword:a,getAuthConfig:l,refreshToken:u,fetchUserInfo:c,logout:async()=>{if(e.value)try{await fetch("/api/auth/logout",{method:"POST",headers:{Authorization:`Bearer ${e.value}`}})}catch{}o(null),s(null),sessionStorage.removeItem("yprompt_config_session_loaded"),["user_prompt_optimize_data","yprompt_optimize_active_mode","yprompt_optimize_cache","yprompt_user_optimize_active_tab","yprompt_optimize_loaded_user_prompt","yprompt_optimize_result","yprompt_generate_messages","yprompt_generate_prompt_data","yprompt_settings_cache"].forEach(v=>{localStorage.removeItem(v)}),Object.keys(localStorage).forEach(v=>{(v.startsWith("yprompt_")||v.startsWith("user_prompt_"))&&v!=="yprompt_token"&&v!=="yprompt_user"&&localStorage.removeItem(v)})},initialize:async()=>{r(),e.value&&!t.value&&await c()}}}),Nb=Object.freeze(Object.defineProperty({__proto__:null,useAuthStore:Mp},Symbol.toStringTag,{value:"Module"})),Vi=`# Architecting Intelligence: A Definitive Guide to the Art and Science of Elite Prompt Engineering
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const lw=({name:e,iconNode:t,absoluteStrokeWidth:i,"absolute-stroke-width":n,strokeWidth:o,"stroke-width":s,size:r=zn.width,color:a=zn.stroke,...l},{slots:u})=>Fe("svg",{...zn,...l,width:r,height:r,stroke:a,"stroke-width":_c(i)||_c(n)||i===!0||n===!0?Number(o||s||zn["stroke-width"])*24/Number(r):o||s||zn["stroke-width"],class:aw("lucide",l.class,...e?[`lucide-${Pc(rw(e))}-icon`,`lucide-${Pc(e)}`]:["lucide-icon"])},[...t.map(c=>Fe(...c)),...u.default?[u.default()]:[]]);/**
 * @license lucide-vue-next v0.544.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
