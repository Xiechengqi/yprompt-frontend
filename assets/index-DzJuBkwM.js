const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LoginView-luLrqxwO.js","assets/check-Bj-drwkV.js","assets/LoginView-BSFPygD1.css","assets/GenerateModule-DOrR-MCh.js","assets/apiService-B5YTZ6eh.js","assets/ModelDialog.vue_vue_type_script_setup_true_lang-Ddbf0apQ.js","assets/FinalTab.vue_vue_type_script_setup_true_lang-DGE1yY3f.js","assets/FinalTab-CDvh1RBw.css","assets/SavePromptDialog.vue_vue_type_script_setup_true_lang-vr2JJCQz.js","assets/OptimizeModule-CWipxkC3.js","assets/SettingsModal.vue_vue_type_script_setup_true_lang-CDcOlYeF.js","assets/OptimizeModule-C8JMchR2.css","assets/PlaygroundModule-C_R5s3Hh.js","assets/PlaygroundModule-BDv4wRAz.css","assets/LibraryModule-CMWvVV5Z.js","assets/LibraryModule-CsIas7Q0.css"])))=>i.map(i=>d[i]);
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const xw=No("x",[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]]),Cw={class:"fixed top-4 right-4 z-50 space-y-2"},Ew={class:"p-4"},Rw={class:"flex items-start"},Ow={class:"flex-shrink-0"},Mw={class:"ml-3 flex-1 min-w-0"},Nw={class:"text-sm font-medium break-words"},Lw={class:"ml-4 flex-shrink-0"},Fw=["onClick"],Dw=kt({__name:"NotificationContainer",setup(e){const t=ww(),i=o=>{switch(o){case"success":return"bg-green-50 border border-green-200 text-green-800";case"error":return"bg-red-50 border border-red-200 text-red-800";case"warning":return"bg-yellow-50 border border-yellow-200 text-yellow-800";case"info":return"bg-blue-50 border border-blue-200 text-blue-800";default:return"bg-gray-50 border border-gray-200 text-gray-800"}},n=o=>{switch(o){case"success":return Iw;case"error":return Pw;case"warning":return _w;case"info":return Lc;default:return Lc}};return(o,s)=>(ye(),We("div",Cw,[(ye(!0),We(xe,null,Gs(we(t).notifications,r=>(ye(),We("div",{key:r.id,class:ki([["max-w-md w-full shadow-lg rounded-lg pointer-events-auto overflow-hidden",i(r.type)],"transform transition-all duration-300 ease-in-out"])},[ke("div",Ew,[ke("div",Rw,[ke("div",Ow,[(ye(),Mt(wa(n(r.type)),{class:"h-5 w-5"}))]),ke("div",Mw,[ke("p",Nw,On(r.message),1)]),ke("div",Lw,[ke("button",{onClick:a=>we(t).removeNotification(r.id),class:"inline-flex text-gray-400 hover:text-gray-600 focus:outline-none transition-colors"},[ue(we(xw),{class:"h-4 w-4"})],8,Fw)])])])],2))),128))]))}}),qw={id:"app"},Bw=kt({__name:"App",setup(e){const t=Db(),i=Xa(),n=zp(),o=Le(()=>!t.currentRoute.value.meta.public),s=()=>{i.setMobile(window.innerWidth<1024)},r=()=>{const a=t.currentRoute.value.path,l=i.getModuleByPath(a);l&&i.setCurrentModule(l.id)};return Fn(async()=>{s(),window.addEventListener("resize",s),await n.initialize(),r(),t.afterEach(r)}),xo(()=>{window.removeEventListener("resize",s)}),(a,l)=>{const u=Dn("router-view");return ye(),We("div",qw,[o.value?(ye(),We(xe,{key:0},[we(i).isMobile?(ye(),Mt(bw,{key:1})):(ye(),Mt(hw,{key:0}))],64)):(ye(),Mt(u,{key:1})),ue(Dw)])}}}),Uw=Wp(Bw,[["__scopeId","data-v-8778b8c4"]]),Gp=Lb({history:ub(),routes:[{path:"/login",name:"login",component:()=>Oe(()=>import("./LoginView-luLrqxwO.js"),__vite__mapDeps([0,1,2])),meta:{public:!0}},{path:"/",redirect:"/generate"},{path:"/generate",name:"generate",component:()=>Oe(()=>import("./GenerateModule-DOrR-MCh.js"),__vite__mapDeps([3,4,5,6,1,7,8]))},{path:"/optimize",name:"optimize",component:()=>Oe(()=>import("./OptimizeModule-CWipxkC3.js"),__vite__mapDeps([9,5,8,6,1,7,10,11]))},{path:"/optimize/:id?",name:"optimize-prompt",component:()=>Oe(()=>import("./OptimizeModule-CWipxkC3.js"),__vite__mapDeps([9,5,8,6,1,7,10,11]))},{path:"/playground",name:"playground",component:()=>Oe(()=>import("./PlaygroundModule-C_R5s3Hh.js").then(e=>e.bd),__vite__mapDeps([12,10,5,13]))},{path:"/library",name:"library",component:()=>Oe(()=>import("./LibraryModule-CMWvVV5Z.js"),__vite__mapDeps([14,8,15]))}]}),zw=qb(),el=bs(Uw);el.use(zw);el.use(Gp);Gp.beforeEach(async(e,t,i)=>{const{useAuthStore:n}=await Oe(async()=>{const{useAuthStore:s}=await Promise.resolve().then(()=>Vb);return{useAuthStore:s}},void 0),o=n();if(e.meta.public){i();return}if(!o.isLoggedIn){i({path:"/login",query:{redirect:e.fullPath}});return}i()});el.mount("#app");export{Dn as $,Mm as A,Qt as B,Th as C,Ln as D,ww as E,xe as F,jp as G,Oe as H,Jb as I,xo as J,X as K,_a as L,Xa as M,_h as N,Dw as O,Mn as P,xs as Q,Fg as R,jw as S,tg as T,qf as U,Ws as V,Iw as W,xw as X,Ea as Y,Tt as Z,Wp as _,Le as a,eo as a0,Vn as a1,Db as b,No as c,kt as d,We as e,ke as f,ue as g,io as h,df as i,we as j,Ch as k,Mt as l,Ca as m,ki as n,Fn as o,Po as p,Gn as q,pe as r,ye as s,On as t,zp as u,vs as v,Ng as w,tr as x,Gs as y,Rn as z};
